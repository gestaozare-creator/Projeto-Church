    ...
    >
      <div className="header" style={{ marginBottom: "10px" }}>
        <div>
          ...
          >
            🛡️ Departamento de Obreiros
          </h2>
          <span style={{ fontSize: "0.85rem", color: "var(--text-secondary)" }}>
            Alocação e Posicionamento no Templo
          </span>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          {participacoesMes.length === 0 ? (
            ...
            >
              Nenhuma escala computada neste mês.
            </div>
          ) : (
            <div
              style={{
                    ...
                    {hasScale && (
                      <div
                        style={{
                          ...
                          height: "4px",
                          borderRadius: "50%",
                          background: isActive ? "#fff" : "#f1c40f",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            <button
              onClick={async () => {
                ...
                const texto = `📋 *Escala do Ministério de Obreiros*\n🗓️ ${mes}\n\n👇 Confira a sua escala:\n${url}`;
