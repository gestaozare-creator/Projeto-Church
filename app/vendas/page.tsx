  ...
  return (
    <div className={`vendas-container ${theme}`} style={{ width: '100%', minHeight: '100vh', fontFamily: 'system-ui, -apple-system, sans-serif', transition: 'all 0.3s' }}>
          ...
          <div style={{ flex: '1 1 500px', display: 'flex', flexWrap: 'wrap', gap: '20px', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ width: '230px', background: '#111', borderRadius: '35px', padding: '10px', boxShadow: '-15px 25px 50px rgba(0,0,0,0.8), inset 0 0 0 2px #444', position: 'relative' }}>
              ...
              <div style={{ background: '#000', borderRadius: '25px', overflow: 'hidden', aspectRatio: '9/19.5', position: 'relative' }}>
                <img src="/formulario vistante.png" alt="Formulário Exclusivo para Visitantes" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'top center', transform: 'scale(1.05)', transformOrigin: 'top center' }} />
              </div>
            </div>
          </div>
          <div style={{ flex: '1 1 400px' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px', alignItems: 'center', flexDirection: 'row-reverse', marginBottom: '80px' }}>
          <div style={{ flex: '1 1 500px', display: 'flex', flexWrap: 'wrap', gap: '20px', alignItems: 'center', justifyContent: 'center', flexDirection: 'row-reverse' }}>
            ...
            <div style={{ width: '230px', background: '#111', borderRadius: '35px', padding: '10px', boxShadow: '15px 25px 50px rgba(0,0,0,0.8), inset 0 0 0 2px #444', position: 'relative' }}>
              <div style={{ position: 'absolute', top: 0, left: '50%', transform: 'translateX(-50%)', width: '100px', height: '25px', background: '#111', borderRadius: '0 0 15px 15px', zIndex: 2 }}></div>
              <div style={{ background: '#000', borderRadius: '25px', overflow: 'hidden', aspectRatio: '9/19.5', position: 'relative' }}>
                <img src="/formulario membro.png" alt="Formulário de Cadastro de Membro" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'top center', transform: 'scale(1.05)', transformOrigin: 'top center' }} />
              </div>
            </div>
          </div>
          <div style={{ flex: '1 1 400px' }}>
      ...
      <section id="modulo-financeiro" style={{ padding: '80px 20px', maxWidth: '1200px', margin: '0 auto', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px', alignItems: 'center', marginBottom: '80px' }}>
          <div style={{ flex: '1 1 500px' }}>
            <div style={{ width: '100%', aspectRatio: '4/3', borderRadius: '16px', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 20px 40px rgba(0,0,0,0.4)' }}>
              <img src="/financeiro-modais.png" alt="Lançamento de Receitas" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
            </div>
          </div>
          <div style={{ flex: '1 1 400px' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px', alignItems: 'center', flexDirection: 'row-reverse', marginBottom: '80px' }}>
          <div style={{ flex: '1 1 500px' }}>
            <div style={{ width: '100%', aspectRatio: '4/3', borderRadius: '16px', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 20px 40px rgba(0,0,0,0.4)' }}>
              <img src="/financeiro-modais1.png" alt="Lançamento de Despesas e Patrimônio" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
            </div>
          </div>
          <div style={{ flex: '1 1 400px' }}>
